    ...
    <div className="J_shippingOptions">
      <div className="J_optionGroup">
        ...
        <label>
          ...
          7-11 超商取貨 <span className="J_price">$60</span>
        </label>
        <label>
          <input type="radio" name="shipping" value="familymart" />
          全家 超商取貨 <span className="J_price">$60</span>
        </label>
      </div>
      ...
      <div className="J_optionGroup">
        ...
        <label>
          ...
          郵寄掛號 <span className="J_price">$80</span>
        </label>
        <label>
          <input type="radio" name="shipping" value="home" />
          宅配/快遞寄送 <span className="J_price">$80</span>
        </label>
        <label>
