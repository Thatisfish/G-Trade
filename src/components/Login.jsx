        ...
        <>
            <div className="c_backDrop" onClick={onClose}>
                <div className="c_loginBox" onClick={(e) => { e.stopPropagation() }}>
                    <button className="c_close-btn" onClick={onClose} aria-label="關閉">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 2L46 46M2 46L46 2" stroke="black" strokeWidth="3" />
                        </svg>
                    </button>
                    <h2>登入</h2>
                    <form className="c_loginForm" action="" method="post" onSubmit={(e) => { e.preventDefault() }}>
                        ...
                        <p>繼續即表示你同意我們的<a href="#">《服務條款》</a>，並確認你已了解 <a href="#">《隱私權政策》</a></p>
